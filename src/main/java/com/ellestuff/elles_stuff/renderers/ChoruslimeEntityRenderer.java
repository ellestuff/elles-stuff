package com.ellestuff.elles_stuff.renderers;
...
public class ChoruslimeEntityRenderer extends MobEntityRenderer<SlimeEntity, SlimeEntityModel<SlimeEntity>> {
	private static final Identifier TEXTURE = new Identifier("textures/entity/choruslime/choruslime.png");

	public ChoruslimeEntityRenderer(EntityRendererFactory.Context context) {
